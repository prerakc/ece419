...
public class DistributedKVServerTest extends TestCase {
    ...
    public void testTotalReplication() {
        ...
        KVStorage kvstore;
        for (int i=0;i<3;i++){
            kvstore = new KVStorage("./data", String.format("%s:%d.properties", TestingVars.SERVER_A_ADDRESS,TestingVars.PORT_ARRAY[i]));
            for (int j=0;j<5;j++){
    ...
    public void testRemoveReplicas() {
        ...
        KVStorage kvstore;
        for (int i=0;i<3;i++){
            kvstore = new KVStorage("./data", String.format("%s:%d.properties", TestingVars.SERVER_A_ADDRESS,TestingVars.PORT_ARRAY[i+1]));
            for (int j=0;j<5;j++){
                inValue = kvstore.exists("key"+j);
                //System.out.println(inValue);
                try{Thread.sleep(500);}catch(InterruptedException e){System.out.println(e);}
    ...
    public void testRestore() {
        ...
        kvstore = new KVStorage("./data", String.format("%s:%d.properties", TestingVars.SERVER_A_ADDRESS,TestingVars.PORT_ARRAY[1]));
        for (int j=0;j<5;j++){
            inValue = kvstore.exists("key"+j);
            System.out.println(inValue);
    ...
    public void testShutDownPartialRebalanceFour() {
        ...
        kvClient.disconnect();
        TestingUtils.spinDownServer();
        KVStorage kvstoreA = new KVStorage("./data", String.format("%s:%d.properties", TestingVars.SERVER_A_ADDRESS,TestingVars.PORT_ARRAY[1]));
        ...
        KVStorage kvstoreB = new KVStorage("./data", String.format("%s:%d.properties", TestingVars.SERVER_A_ADDRESS,TestingVars.PORT_ARRAY[4]));
