...
public class TestingUtils {
    ...
    public static void spinUpServers(int count, String dataDir, String dataProps){
        ...
        for (int i=size; i < count + size;i++){
            ...
            try{
                //System.out.println("java "+ "-jar "+ "m2-server.jar "+ TestingVars.SERVER_A_ADDRESS+ " "+TestingVars.PORT_ARRAY[i]+ " "+0+ " foo "+TestingVars.ECS_ADDRESS + " "+TestingVars.ECS_PORT);
                ProcessBuilder builder = new ProcessBuilder("java", "-jar", "m2-server.jar", TestingVars.SERVER_A_ADDRESS, ""+(TestingVars.SERVER_A_PORT + i), "0", "foo", TestingVars.ECS_ADDRESS, ""+TestingVars.ECS_PORT);
