...
public class DistributedKVStoreTest extends TestCase {
    ...
    static {
        ...
        // Thread.currentThread().interrupt();
        // }
        // new KVServer(address, serverPort1, cacheSize, strategy, address, ecsPort,
        // dataDir, dataProps1).start();
        // try {
        // Thread.sleep(5000);
        // } catch (InterruptedException e) {
        // Thread.currentThread().interrupt();
        // }
        // new KVServer(address, serverPort2, cacheSize, strategy, address, ecsPort,
        // dataDir, dataProps2).start();
        // try {
        // Thread.sleep(5000);
        // } catch (InterruptedException e) {
        // Thread.currentThread().interrupt();
    ...
    // // assertSame(response.getValue(),
    // "93328924524456121601951623841295194894\r\n");
