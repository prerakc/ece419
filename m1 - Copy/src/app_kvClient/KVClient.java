...
public class KVClient implements IKVClient {
    ...
    public void newConnection(String hostname, int port) throws Exception {
        ...
        kvStore.connect();
        logger.info("KVClient: Established connection to storage server");
    }
    ...
    public void run() {
        while (!stop) {
            ...
            try {
                ...
                logger.error("KVClient: CLI not responding");
            }
        }
    }
    ...
    private void handleCommand(String cmdLine) {
        ...
        if (tokens[0].equals("connect")) {
            ...
            logger.info("KVClient: Application exited and client connection to server disconnected");
        }
